...
$description = new Description([
    'baseUri' => 'http://api.acoustid.org/v2/',
    'operations' => [
        'lookup' => [
            'httpMethod' => 'GET',
            'uri' => '/lookup',
...
$client = new \AcoustidApi\AcoustidClient('xWalOMJnHA0');

try {
    $fingerprint = new \AcoustidApi\RequestModel\FingerPrint(
    ...
    $result = $client->lookupByFingerPrint($fingerprint, [\AcoustidApi\Meta::RECORDINGS]);
